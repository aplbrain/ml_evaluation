...
outputs:
  trainedParamsDir:
    type: Directory
    outputBinding:
      glob: $(inputs.prefix + "-params")

requirements:
  - class: InitialWorkDirRequirement
    listing:
      - "$({class: 'Directory', basename: inputs.prefix + '-params', listing: []})"
...
#  - --user=$(inputs.user)
  ...
  - --volume=$(runtime.outdir):/output:rw
  - --volume=$(runtime.outdir)/$(inputs.prefix)-params:/output/params:rw
  - $(inputs.imageName)
